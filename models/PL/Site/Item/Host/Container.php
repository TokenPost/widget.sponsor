<?php
namespace PL\Models\Site\Item\Host;
use Exception;
use Phalcon\Db;
use Phalcon\DI;
...
class Container extends AbstractContainer {
    ...
    public function __construct(Item $itemInstance = null) {
        parent::__construct(Host::tableName);
        $this->setTableName(Host::tableName);
    ...
    public static function getObjectInstanceStatic($data) : Host {
        return Host::getInstance($data);
    }

    public function getObjectInstance($data) : Host {
        return Host::getInstance($data);
    }
    ...
    public function getItemsPBF(){
        ...
        if($this->getHost() != '') $where[] = '`host` = "' . $this->getHost() . '"';
        return $where;
    }
}