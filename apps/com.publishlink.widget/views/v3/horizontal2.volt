...
{% block embedStyle %}
    ...
    <link rel="stylesheet" type="text/css" href="{{ staticUrl }}/assets/css/widget/horizontal2.v3.css?r={{ cssRevision }}"/>
    <link rel="stylesheet" type="text/css" href="{{ staticUrl }}/assets/css/widget/media.v3.css?r={{ cssRevision }}"/>
    <link rel="stylesheet" type="text/css" href="{{ staticUrl }}/assets/css/widget/media2.v3.css?r={{ cssRevision }}"/>
{% endblock %}
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.error != 0) {
                                ...
                                $('.closeBtn2, .noticeBtnCancel').on('click', function (){
                                ...
                                $('#reward').on('click', function (){
                                    ...
                                    $('div.widgetRewardWrap .closeBtn').on('click', function (){
                                ...
                                $('#share').on('click', function (){
                                    $("div.widgetProfileWrap").addClass('hide');
                                    $("#widgetSnsLoginWrap").addClass('hide');
                                    $("#widgetShareWrap").removeClass('hide');
                                    $('div.widgetShareWrap .closeBtn').on('click', function (){
                                        $("div.widgetShareWrap").addClass('hide');
                                        $("div.widgetProfileWrap").removeClass('hide');
                                    });
                                });
                                $('#myPage').on('click', function (){
                                    window.open("{{ protocol }}://{{ serviceUrl }}/mypage/index");
                                });
                                ...
                                {# 회원 정보 뿌려주기 #}
                                {# 회원 기본 정보 #}
                                $('span#userName').text(response.item.name);
                                ...
                                {# 회원 적립내역, 보유 포인트 #}
                                {# 보유 자산 #}
                                $('p#pointSum').text(response.item.pPoint);
                                $('p#newsSum').text(response.item.news);
                                {# 하루 적립내역 #}
                                var nsign = '';
                                ...
                                $('p.newsArea span#pointNumber').text(nsign + Math.abs(nDifference));
                                ...
                                $('p.pointArea span#pointNumber').text(psign + Math.abs(pDifference));
                                ...
                                if(response.item.toastDisplay == 'Y') {
                                    ...
                                    $('#widgetRewardNotice').css('border-radius', '20px');
...
//                    $.memberInfo(clientId);
                ...
                {# 로그아웃 시작 #}
                $('div.widgetProfileWrap #logout, .noticeWrap span.logout').on('click', function() {
                ...
                $('#reward').on('click', function (){
                   ...
                   $('#widgetRewardWrap').removeClass('hide');
                });
        ...
        <div class="inner widgetInner">
            <div class="horizonType ">
                <div class="widgetArea">
                    ...
                    {# 메인 시안2 #}
                    <div id="widgetProfileWrap" class="widgetProfileWrap widgetProfileWrap2 {% if clientSession != 'Y' %}hide{% endif %}">
                        <div class="widgetProfileInner">
                            {# 보유량 영역 #}
                            <div class="left">
                                <div class="leftBox">
                                    <div class="leftBoxInner">
                                        <p id="userNameWrap" class="userNameWrap webView">
                                            <span id="userName" class="userName">
                                                {% if clientSession == 'Y' %}
                                                    {% if clientInstance.getInformationInstance().getName() == '' %}
                                                        {{ clientName }}
                                                    {% else %}
                                                        {{ clientInstance.getInformationInstance().getName() }}
                                                    {% endif %}
                                                {% endif %}
                                            </span>님
                                        </p>
                                            ...
                                            <div class="pointInner">
                                                <p class="pointArea">
                                                    {% if clientSession == 'Y' %}
                                                        ...
                                                        {% endif %}
                                                    {% endif %}
                                                    <span id="pointNumber" class="pointNumber number">{% if clientSession == 'Y' %}{{ psign }}{{ pDifference | abs }}{% endif %}</span><span class="pPoint point">P.Point</span>
                                                </p>
                                               
                                                <p id="pointSum" class="pointSum sum ellipsis1">{% if clientSession == 'Y' %}{{ ppoint }}{% endif %}</p>
                                            </div>
                                            <div class="newsInner">
                                                <p class="newsArea">
                                                    {% if clientSession == 'Y' %}
                                                        ...
                                                        {% endif %}
                                                    {% endif %}
                                                    <span id="pointNumber" class="pointNumber number">{% if clientSession == 'Y' %}{{ nsign }}{{ nDifference | abs }}{% endif %}</span><span class="news point">NEWS</span>
                                                </p>
                                                
                                                <p id="newsSum" class="newsSum sum ellipsis1">{% if clientSession == 'Y' %}{{ news }}{% endif %}</p>
                                            </div>
                                        </div>
                                        <div class="logoWrap">
                                            <img src="{{ staticUrl }}/assets/images/front/widget/main/img/widgetPuslighLogo.svg" alt="퍼블리시링크" class="logo">
                                        </div>
                                    </div>
                                    {# 모바일에서 표출 시작 #}
                                    <p class="notice mobileView">*본 서비스는 언론사에서 운영되고 있습니다. </p>
                                    {# 모바일에서 표출 끝 #}
                                </div>
                            </div>
                            {# 아이콘 영역 #}
                            <div class="right">
                                <div class="rightBox">
                                    <ul>
                                        <li id="reward" class="iconTxt">
                                            <img src="{{ staticUrl }}/assets/images/front/widget/main/icon/iconHeart.svg" alt="" class="icon">
                                            <span>언론사후원</span>
                                        </li>
                                        <li id="share" class="iconTxt">
                                            <img src="{{ staticUrl }}/assets/images/front/widget/main/icon/iconShare.svg" alt="" class="icon">
                                            <span>기사공유</span>
                                        </li>
                                        <li id="myPage" class="iconTxt">
                                            <img src="{{ staticUrl }}/assets/images/front/widget/main/icon/iconMypage.svg" alt="" class="icon">
                                            <span>마이페이지</span>
                                        </li>
                                        {# 모바일에서 표출 시작 #}
                                        <li id="logout" class="iconTxt mobileView">
                                            <img src="{{ staticUrl }}/assets/images/front/widget/main/icon/iconLogout.svg" alt="" class="icon">
                                            <span>로그아웃</span>
                                        </li>
                                        {# 모바일에서 표출 끝 #}
                                    </ul>
                                    <div class="noticeWrap webView">
                                        <p class="notice">*해당 서비스는 언론사에서 운영되는 서비스입니다.</p>
