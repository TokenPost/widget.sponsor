        ...
        $.factoryComment = function (type, target, response) {
            ...
            if(type == 'more'){
                ...
                if(target.closest('.addComment').find('.commentVoteUp').hasClass('voteUpVoted') == true){
                    ...
                    target.closest('.addComment').next().find('.commentVoteUp').find('img').attr('src', staticUrl + '/assets/images/front/base/icon/voteUpOnSmall.svg');
                }
                if(target.closest('.addComment').find('.commentVoteDown').hasClass('voteDownVoted') == true){
                    ...
                    target.closest('.addComment').next().find('.commentVoteDown').find('img').attr('src', staticUrl + '/assets/images/front/base/icon/voteDownSmall.svg');
                }
                        ...
                        if (response.error != 0) {
                            ...
                            if(typeId == 1){
                                if(target.hasClass('voteUpVoted')) {
                                    ...
                                    target.attr('src', staticUrl + '/assets/images/front/base/icon/voteUpOnSmall.svg');
                                    target.next().text( parseInt(target.next().text()) + 1);
                                }
                            } else if(typeId == 2) {
                                if(target.hasClass('voteDownVoted')){
                                    ...
                                    target.attr('src', staticUrl + '/assets/images/front/base/icon/voteDownOnSmall.svg');
                                    target.next().text( parseInt(target.next().text()) + 1);
                                }
